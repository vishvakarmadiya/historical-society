...
@section('content')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div class="app-content flex-column-fluid">
            <div class="app-container container-xxl">
                <form class="form" action="{{ route('admin.navigations.update', $navigation->id) }}" id="form_id"
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100">
                            ...
                            <div class="card-body">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2"
                                        value="{{ $navigation->title }}" placeholder="Title" required>
                                </div>
                                <div class="w-150px">
                                    <select class="form-select px-5" data-control="select2" data-hide-search="true"
                                        data-placeholder="Status" data-kt-ecommerce-product-filter="status"
                                        name="is_active">
                                        <option value="1" @if ($navigation->is_published == '1') selected @endif>Active
                                        </option>
                                        <option value="0" @if ($navigation->is_published == '0') selected @endif>Deactivate
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-body">
                                <div class="fv-row">
                                    <div class="d-flex fv-row mt-0 background_color-content">
                                        <div class="w-100">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="colorPicker">
                                                        ...
                                                        <input type="color" name="parent_text_color"
                                                            value="{{ $navigation->parent_text_color }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="colorPicker">
                                                        ...
                                                        <input type="color" name="parent_text_hover_color"
                                                            value="{{ $navigation->parent_text_hover_color }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                        ...
                                        <div class="w-100">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="colorPicker">
                                                        ...
                                                        <input type="color" name="background_color"
                                                            value="{{ $navigation->background_color }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="colorPicker">
                                                        <label class="colorCode">#252626</label>
                                                        <input type="color" name="text_link_color"
                                                            value="{{ $navigation->text_link_color }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="colorPicker">
                                                        ...
                                                        <input type="color" name="hover_background_color"
                                                            value="{{ $navigation->hover_background_color }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="colorPicker">
                                                        ...
                                                        <input type="color" name="link_hover_color"
                                                            value="{{ $navigation->link_hover_color }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                    ...
                    <textarea style="display: none;" class="form-control mb-2" id="storeObjectItems" name="storeObjectItems"
                        rows="15" cols="15">{{ $navigation->items }}</textarea>
                </form>
            </div>
        </div>
    </div>
        ...
        <form id="form-render-items" method="post" class="card w-100 border-0 rounded-0">
            ...
            <div class="card-body">
                ...
                <div class="mb-5 w-100">
                    ...
                    <input type="text" name="popup_text" id="popup_text" class="form-control" placeholder="Text"
                        required>
                </div>
                <div class="mb-5 w-100">
    ...
    <div class="editFooter d-none">@php print_r(json_decode(json_encode($navigation->items))); @endphp</div>
    ...
    <script>
        function footerLoadHtml(){
            ...
            if (editFooter != "") {
                ...
                const itemsHtml = (id, link, linkType, title, subMenu, childrenMenu, popupType) => {
                    ...
                    let childrenItems = "";
                    if (childrenMenu != false && typeof childrenMenu != "undefined") {
                        childrenItems = `${childrenMenu}`;
                    }
                ...
                obj.length > 0 && obj.map(ls => {
                    ...
                    ls.subItems.length > 0 && ls.subItems.map(lss => {
                        ...
                        let childrenMenuHtml = "";
                        if(lss.childrenItems){
                            lss.childrenItems.length > 0 && lss.childrenItems.map(lsss => {
                                childrenMenuHtml += itemsHtml(lsss.id, lsss.link, lsss.linkType, lsss.title, false, false, 'sub-children-menu');
                            })
                        }

                        subMenuHtml += itemsHtml(lss.id, lss.link, lss.linkType, lss.title, false,
                            childrenMenuHtml, 'sub-menu');
                    })



                    htmlItems += itemsHtml(ls.parentItems.id, ls.parentItems.link, ls.parentItems.linkType, ls
                        .parentItems.title, subMenuHtml, false, 'parent')
