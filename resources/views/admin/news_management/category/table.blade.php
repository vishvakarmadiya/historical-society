{{-- <table class="table align-middle table-row-dashed fs-6 gy-5">
    <thead>
        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
            ...
            @canany(['news-categories-edit', 'news-categories-delete'])
    ...
    <table class="table table-responsive align-middle fs-6 gy-5">
        <thead style="background-color:#00315C; color: white; border-bottom: 2px solid #004761;">
            <tr class="text-start fw-bold fs-7 text-uppercase gs-0" style="letter-spacing: 0.05em;">
                ...
                @canany(['news-cetegories-edit', 'news-categories-delete'])
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-45px me-5">
                            <img src="{{ asset('backend/admin/images/news_management/categories/' . $category->image) }}"
                ...
                <td>
                    @if ($category->is_active == '1')
                        <a href="{{ route('admin.news-categories.show', $category->id) }}?status=0">
                            <div class="badge badge-light-success">Active</div>
                        </a>
                    @else
                        <a href="{{ route('admin.news-categories.show', $category->id) }}?status=1">
