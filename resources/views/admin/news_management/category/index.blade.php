            ...
            <div class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    @can('news-categories-create')
                        <a href="{{ route('admin.news-categories.create') }}" class="btn btn-sm fw-bold text-white" style="background-color:#AB0635">Create New
                            Category</a>
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body pt-0">
                        ...
                        <div id="table">
                            @include('admin.news_management.category.table')
                        </div>
                    </div>
                </div>
            </div>
